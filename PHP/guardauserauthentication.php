...
<script type="text/javascript">
    ...
    function loginfailed () {
        setTimeout("window.location='../HTML/loginguarda.html'", 5000);
    }
</script>
</head>
...
$sql = mysqli_query($conexao, "SELECT * FROM guarda WHERE login = '$login' AND senha = '$senha'") or die(mysqli_error($conexao));
