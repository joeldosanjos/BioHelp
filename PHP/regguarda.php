            ...
            <div class = "fundomeio">
                <br> <br> <br> <br>
                    ...
                    <div class="wrapper" align = "center">
                        <form class="login" method="post" action = "incluirg.php">
                            <p class="title">Cadastro de Guarda Florestal</p>
                            ...
                            <input oninput = "maxLengthCheck(this)" type="number" name = "cpf" max="99999999999" min="0" maxlength="11" placeholder="Número do CPF" autofocus/>
